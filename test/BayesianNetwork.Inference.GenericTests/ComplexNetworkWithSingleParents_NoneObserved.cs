...
public abstract class ComplexNetworkWithSingleParents_NoneObserved
{
    ...
    public void Setup()
    {
        ...
        _Y1 = new Node(cpt: TensorHelpers.GenerateRandomProbabilityMatrix([2, 2]), parents: [_Q1], name: "Y1");
        _Y2 = new Node(cpt: TensorHelpers.GenerateRandomProbabilityMatrix([3, 3]), parents: [_Q2], name: "Y2");
        _Y3 = new Node(cpt: TensorHelpers.GenerateRandomProbabilityMatrix([3, 4]), parents: [_Q2], name: "Y3");
        _Y4 = new Node(cpt: TensorHelpers.GenerateRandomProbabilityMatrix([2, 2]), parents: [_Q3], name: "Y4");
        _Y5 = new Node(cpt: TensorHelpers.GenerateRandomProbabilityMatrix([2, 3]), parents: [_Q3], name: "Y5");
    ...
    {
        // Assign
        Tensor pQ1_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->i",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pQ2_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->j",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pQ3_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->k",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
    ...
    public void InferSingleNodeWithParents_NoObservations_CorrectInference()
    {
        // Assign
        // Assign
        Tensor pQ2xQ1_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->ij",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pQ3xQ2_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->jk",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pY1xQ1_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->ia",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pY2xQ2_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->jb",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pY3xQ2_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->jc",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pY4xQ3_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->kd",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        Tensor pY5xQ3_expected = einsum("i, ij, jk, ia, jb, jc, kd, ke->ke",
                                           _Q1.Cpt, _Q2.Cpt, _Q3.Cpt, _Y1.Cpt, _Y2.Cpt, _Y3.Cpt, _Y4.Cpt, _Y5.Cpt);
        ...
        Assert.Multiple(() =>
        {
            AssertHelpers.AssertTensorEqual(pQ2xQ1_expected, pQ2xQ1_actual);
            AssertHelpers.AssertTensorEqual(pQ3xQ2_expected, pQ3xQ2_actual);
