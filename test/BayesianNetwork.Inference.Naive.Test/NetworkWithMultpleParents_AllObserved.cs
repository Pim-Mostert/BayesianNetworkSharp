...
public class NetworkWithMultpleParents_AllObserved
{
    ...
    {
        // Assign
        Tensor pQ1_expected = torch.einsum("i, ij, ijk, i, j, k->i",
            _Q1.Cpt,
            _Q2.Cpt,
            _Y.Cpt,
        ...
        Tensor pQ2_expected = torch.einsum("i, ij, ijk, i, j, k->j",
            _Q1.Cpt,
            _Q2.Cpt,
            _Y.Cpt,
            _evidence.GetState(_Q1).AsTensor(),
        ...
        Tensor pY_expected = torch.einsum("i, ij, ijk, i, j, k->k",
            _Q1.Cpt,
            _Q2.Cpt,
            _Y.Cpt,
            _evidence.GetState(_Q1).AsTensor(),
    ...
    {
        // Assign
        Tensor pQ1xQ2_expected = torch.einsum("i, ij, ijk, i, j, k->ij",
            _Q1.Cpt,
            _Q2.Cpt,
            _Y.Cpt,
            _evidence.GetState(_Q1).AsTensor(),
        ...
        Tensor pQ1xQ2xY_expected = torch.einsum("i, ij, ijk, i, j, k->ijk",
            _Q1.Cpt,
            _Q2.Cpt,
            _Y.Cpt,
            _evidence.GetState(_Q1).AsTensor(),
